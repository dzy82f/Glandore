...
require_once get_template_directory() . '/inc/sitemap-clean.php';
require_once get_template_directory() . '/inc/analytics-consent.php'; 
...
// require_once get_template_directory() . '/inc/induction-redirect.php';
...
/**
 * CoP contribution gate.
 *
 * Loaded after modal and login redirect infrastructure so it can
 * refine the contribution-specific login journey.
 */
require_once get_template_directory() . '/inc/cop-contribution-login-redirect.php';
...
require_once get_template_directory() . '/inc/cop-membership.php';
...
add_action( 'wp_enqueue_scripts', function () {
	wp_enqueue_script(
		...
		get_stylesheet_directory_uri() . '/assets/js/issue-studio-result.js',
		array(),
		filemtime( get_stylesheet_directory() . '/assets/js/issue-studio-result.js' ),
		true
	);
} );
...
function glandore_enqueue_footer_controller() {
