...
SELECT
  ...
  'active'
FROM (
  SELECT 'informal-organisation' lens_slug, 'What is being said privately but not publicly?' question_text, 'Explore the gap between official communication and informal organisational reality.' help_text, 10 sort_order
  ...
  'Examine fragmented organisational realities across teams, levels, or functions.',
  80
  ...
  'Distinguish formal approval from informal pre-alignment, influence, and negotiation.',
  110

  UNION ALL SELECT
  'stakeholder',
  'Which people act as information brokers?',
