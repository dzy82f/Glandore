 ...
 *
 * Responsibilities:
 * - Open the "Edit your profile" modal when the user clicks
 *   the link in the Account dashboard (or any trigger).
...
(function () {
  ...
  var MODAL_ID         = 'glandore-modal-account-profile';
  var MODAL_SELECTOR   = '#' + MODAL_ID;
  var TRIGGER_SELECTOR = '[data-auth-modal-open="account-profile"]';
  ...
  // Global handler: X inside account-profile modal → go home.
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    // Open from Account dashboard (and anywhere else).
