...
<main id="primary" class="site-main cop-dialogue-main cop-discussions-page">
	<div class="cop-dialogue-container">
		<div class="entry-content">
			...
			<?php
$cop_current_url = home_url( add_query_arg( null, null ) );

$cop_post_action_url = $cop_discussion_post_url;
$cop_new_post_url    = home_url( '/community-new-post/' );

if (
	function_exists( 'glandore_cop_user_is_member_ready' ) &&
	! glandore_cop_user_is_member_ready()
) {
	$cop_post_action_url = glandore_cop_membership_url( $cop_current_url );
	$cop_new_post_url    = glandore_cop_membership_url( home_url( '/community-new-post/' ) );
}
?>
...
<div class="cop-discussions-actions">
	...
	<a href="<?php echo esc_url( $cop_post_action_url ); ?>" class="button cop-discussions-button">
	...
	<a href="<?php echo esc_url( $cop_new_post_url ); ?>" class="button button-primary cop-discussions-button">
